...
def computer():
    ...
    try:
        ...
        # osce 管理者报告
        stu_admin_student = stu_osce_student
        stationcount = 0
        ...
        student_count = stu_bjkh + stu_zxxl + stu_bjkqxl + stu_bjktxl + stu_tbhz + stu_ksznsb \
                        + stu_osce_student + stu_admin_student + stu_osce_examiner
        teacher_count = teacher_zxxl + teacher_bjkqxl + teacher_bjktxl + teacher_tbhz + teacher_ksznsb \
                        + teacher_bjkh + teacher_osce_examiner + teacher_admin_student + teacher_osce_student
        print student_count, teacher_count
        ...
        dicts = {"student": {"stu_bjkh": stu_bjkh, "stu_zxxl": stu_zxxl, "stu_bjkqxl": stu_bjkqxl, "stu_bjktxl": stu_bjktxl,
                             ...
                             "stu_admin_student": stu_admin_student, "stu_osce_examiner": stu_osce_examiner, "student_count": student_count},
                 "teacher": {"teacher_zxxl": teacher_zxxl, "teacher_bjkqxl": teacher_bjkqxl, "teacher_bjktxl": teacher_bjktxl, "teacher_tbhz": teacher_tbhz,
                             ...
                             "teacher_admin_student": teacher_admin_student, "teacher_osce_student": teacher_osce_student, "teacher_count": teacher_count}
                 }
