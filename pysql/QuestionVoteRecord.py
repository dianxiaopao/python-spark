...
if __name__ == '__main__':
    ...
    cust_no = '1'
    isvalid = '1'
    slaveTempTable = 'questionvoterecord_slave'
    ...
    dff = sqlContext.read.format("jdbc").options(url="jdbc:mysql://192.168.1.200:3306/osce1030?user=root"
                                                     ...
                                                     "&zeroDateTimeBehavior=convertToNull", dbtable="QuestionVoteRecord",
    ...
    dft = sqlContext.read.format("jdbc").options(url="jdbc:mysql://192.168.1.200:3307/bd_ets?user=root"
                                                     ...
                                                     "&zeroDateTimeBehavior=convertToNull", dbtable="ets_questionvoterecord",
                                                       driver="com.mysql.jdbc.Driver").load()
