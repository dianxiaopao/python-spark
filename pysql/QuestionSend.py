...
if __name__ == '__main__':
    ...
    cust_no = '1'
    isvalid = '1'
    slaveTempTable = 'questionsend_slave'
    etsTempTable = 'ets_questionsend'
    ...
    dff = sqlContext.read.format("jdbc").options(url="jdbc:mysql://192.168.1.200:3306/osce1030?user=root"
                                                     ...
                                                     "&zeroDateTimeBehavior=convertToNull", dbtable="QuestionSend",
    ...
    dft = sqlContext.read.format("jdbc").options(url="jdbc:mysql://192.168.1.200:3307/bd_ets?user=root"
                                                     ...
                                                     "&zeroDateTimeBehavior=convertToNull", dbtable="ets_questionsend",
                                                       driver="com.mysql.jdbc.Driver").load()
    ...
    try:
        ...
        # 创建列
        schemaString = "id,qid,schedule_id,sg_id,type,cust_no,isvalid,src_fields,src_fields_md5,createts,updatets"
